...
using Winperax.Application.Modules.Muhasebe.Commands.UpdateMuhasebe;

namespace Winperax.Application.Validators.Muhasebe
{
    public class UpdateMuhasebeCommandValidator : AbstractValidator<UpdateMuhasebeCommand>
    {
        public UpdateMuhasebeCommandValidator()
        {
            RuleFor(x => x.Id)
                .NotEmpty()

...
using Winperax.Application.Modules.Finans.Commands.CreateFinans;

namespace Winperax.Application.Validators.Finans
{
    public class CreateFinansCommandValidator : AbstractValidator<CreateFinansCommand>
    {
        public CreateFinansCommandValidator()
        {
            RuleFor(x => x.EvrakNo)
                .NotEmpty()

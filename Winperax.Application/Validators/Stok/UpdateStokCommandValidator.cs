    ...
    public class UpdateStokCommandValidator : AbstractValidator<UpdateStokCommand>
    {
        public UpdateStokCommandValidator()
        {
            RuleFor(x => x.Id)
                ...
                .Length(1, 50).WithMessage("Stok ID 1 ile 50 karakter arasında olmalıdır.");
            ...
            RuleFor(x => x.SatisFiyati)
                ...
                .GreaterThanOrEqualTo(x => x.AlisFiyati).WithMessage("Satış fiyatı alış fiyatından düşük olamaz.");
